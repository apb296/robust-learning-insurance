...
Q=-Q;
%gradQ=-[der_u(c(1),ra)*tilde_p0_agent_1(1)*(1-beta) der_u(c(2),ra)*tilde_p0_agent_1(2)*(1-beta)  -lambdastar(1)*beta*tilde_p0_agent_1(1) -beta*tilde_p0_agent_1(2)*lambdastar(2)];
