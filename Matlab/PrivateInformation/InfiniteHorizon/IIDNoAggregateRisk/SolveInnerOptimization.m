...
%[OptContract,fval,exitflag,~,Mu]  =fmincon(@(x) QRU(x,Para,c,Q),InitContract,[],[],[],[],Para.KTR.lb,Para.KTR.ub,@(x) DynamicConstraintsRU(x,v,Para,c,Q),Para.KTR.opts);
