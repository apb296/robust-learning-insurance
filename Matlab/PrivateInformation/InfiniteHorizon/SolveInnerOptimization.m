function strucOptimalContract=SolveInnerOptimization(v,InitContract,Para,c,Q)
...
%[OptContract,fval,exitflag,~,Mu]  =ktrlink(@(x) PKFullRiskSharing(x,Para),[InitContract(1) InitContract(1) InitContract(3) InitContract(4)] ,[],[],[-1 1 0 0],[0],Para.KTR.lb,Para.KTR.ub,@(x) DynamicConstraintsFullRiskSharing(x,Para,c,Q),Para.KTR.opts);
