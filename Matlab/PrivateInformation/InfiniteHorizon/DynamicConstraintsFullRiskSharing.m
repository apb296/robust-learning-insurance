...
% Constraints for the ambiguity case. It also computes the gradients
 function [CINQ, CEQ,  gradCINQ, gradCEQ ] = DynamicConstraintsFullRiskSharing(x,Para,coeff,Q)
...
gradCEQ=[-der_u(y-c(1),ra)*tilde_p0_agent_2(1) -der_u(y-c(2),ra)*tilde_p0_agent_2(2) beta*tilde_p0_agent_2(1) beta*tilde_p0_agent_2(2)]'*0;
