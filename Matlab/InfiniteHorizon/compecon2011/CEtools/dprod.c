...
{  double *a, *b, *c; /*are and should remain pointers*/
   unsigned int i, j, k; /*i and j are just iterators, could remain int. k depends on aj, an*/
   mwSize m, an, bn; /*m, an and bn are sizes and of type mwSize.*/
   ...
   else
   {
     ...
     {
       mwSize *ai, *aj, *bi, *bj, *ci, *cj; /*Coming from mxGetJc, mxGetIr.*/
       mwSize ak, anj, bk, bjend, ck; /*Iterators, in a loop with other mwSize variables.*/
       mwSize *acounts, *bcounts; /*Interacting with other mwSize variables.*/
       a=mxGetPr(prhs[0]);
       ai=mxGetIr(prhs[0]);
       aj=mxGetJc(prhs[0]);
       an=mxGetN(prhs[0]);
     ...
     {
       mwSize *bi, *bj, *ci, *cj; /*Coming from mxGetJc, mxGetIr.*/
       mwSize ak, bk, ck, bjj; /*Iterators, in loops with other mwSize variables.*/
       mwSize *acounts, *bcounts; /*Interacting with other mwSize variables.*/
       a=mxGetPr(prhs[0]);
       an=mxGetN(prhs[0]);
       b=mxGetPr(prhs[1]);
     ...
     else if (mxIsSparse(prhs[0]) && mxIsDouble(prhs[1]))
     {
       mwSize *ai, *aj, *ci, *cj;
       double *bj;
       mwSize ak, bk, ck, akk;  /*Interacting with other mwSize variables.*/ 
       mwSize *acounts, *bcounts; /*Interacting with other mwSize variables.*/
       a=mxGetPr(prhs[0]);
       ai=mxGetIr(prhs[0]);
       aj=mxGetJc(prhs[0]);
      ...
      /* DOUBLE/DOUBLE -> DOUBLE */
       ...
       mwSize mbn;  /*Interacting with other mwSize variables.*/
       double *aend;
       an=mxGetN(prhs[0]);
       bn=mxGetN(prhs[1]);
       mbn=bn*m;
