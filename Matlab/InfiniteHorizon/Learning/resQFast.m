...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function resQ=resQ(x,z,pi,v,c,Q,Para)
...
if cons<Y(z)
    ...
    pi_tilde_agent1_model1 = pi*exp(-(u(cons)+delta*T1_agent1(1))/theta2);
    pi_tilde_agent1_model2 =(1-pi)*exp(-(u(cons)+delta*T1_agent1(2))/theta2);
    pi_tilde_agent1=pi_tilde_agent1_model1/(pi_tilde_agent1_model1+pi_tilde_agent1_model2);
    
    
    pi_tilde_agent2_model1 = pi*exp(-(u(Y(z)-cons)+delta*T1_agent2(1))/theta2);
    pi_tilde_agent2_model2 =(1-pi)*exp(-(u(Y(z)-cons)+delta*T1_agent2(2))/theta2);
    ...
    agent2_v=-theta2*log(exp(-(u(Y(z)-cons)+delta*T1_agent2)/theta2)*([pi; 1-pi]));
    resV=agent2_v-v;
